...
* # Node.js Downloads include latest Long Term Support (LTS) version and npm
    ```sh
    senku@Senku:/mnt/c/codes/design 6/iot/lesson6$ node -v
    v19.7.0
    senku@Senku:/mnt/c/codes/design 6/iot/lesson6$ npm -v
    9.5.0
    senku@Senku:/mnt/c/codes/design 6/iot/lesson6$ node -h
    ...
    senku@Senku:/mnt/c/codes/design 6/iot/lesson6$ node hello-world.js
...
* # hello-world.js
    ...
    Server running at http://127.0.0.1:3000/
    ```
    ![](/lab_06/hello-world.PNG)
* # hello.js
    ``` sh
    senku@Senku:/mnt/c/codes/design 6/iot/lesson6$ node hello.js                                              ello.js
...
* # http.js
    ```sh
    senku@Senku:/mnt/c/codes/design 6/iot/lesson6$ node http.js
    0
...
* # Install Pystache and run example code
    ```
    senku@Senku:/mnt/c/codes/design 6/iot/lesson6$ cat say_hello.mustache 
    Hello, {{to}}!
    senku@Senku:/mnt/c/codes/design 6/iot/lesson6$ cat say_hello.py 
    ...
    parsed = pystache.parse('Hey {{#who}}{{.}}!{{/who}}')print(parsed)
    print(renderer.render(parsed, {'who': 'Google'}))    
    print(renderer.render(parsed, {'who': 'Siri'}))  
    senku@Senku:/mnt/c/codes/design 6/iot/lesson6$ python3 say_hello.py
    Hi Alexa!
    Hello, World!
