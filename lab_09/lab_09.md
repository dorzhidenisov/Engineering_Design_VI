...
* # YANG
    ```sh
    senku@Senku:/mnt/c/codes/design 6/iot/lesson9/demo$ cat intrusiondetection.yang
    ...
    senku@Senku:/mnt/c/codes/design 6/iot/lesson9/demo$ pyang -f yin -o intrusiondetection.yin intrusiondetection.yang
    senku@Senku:/mnt/c/codes/design 6/iot/lesson9/demo$ cat intrusiondetection.yin
    ...
    senku@Senku:/mnt/c/codes/design 6/iot/lesson9/demo$ pyang -f uml -o intrusiondetection.uml intrusiondetection.yang --uml-no=stereotypes,annotation,typedef
    senku@Senku:/mnt/c/codes/design 6/iot/lesson9/demo$ cat intrusiondetection.uml
    ...
    center footer
    <size:20> UML Generated : 2023-05-06 11:47 </size>
    endfooter
    @enduml
    senku@Senku:/mnt/c/codes/design 6/iot/lesson9/demo$ python3 -m plantuml intrusiondetection.uml
    [{'filename': 'intrusiondetection.uml', 'gen_success': True}]
    ```
    ![](/lab_09/intrusiondetection.png)